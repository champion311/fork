...
public class CircleUserMineActivity extends BaseActivity implements CircleContract.UserInfoMineView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtil.setColorNoTranslucent(this,
                this.getResources().getColor(R.color.seleted_text_color));
    ...
    protected void initViewAndEvents() {
        if (LoginUtils.isLogin) {
            ...
            options.error(R.drawable.display_avater).placeholder(R.drawable.display_avater).
                    centerCrop().priority(Priority.HIGH);
            GlideUtils.loadImage(this, LoginUtils.getUser().getHeadimg(),
