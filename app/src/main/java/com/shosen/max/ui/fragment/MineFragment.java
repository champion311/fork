...
import com.shosen.max.ui.activity.CommunityAssetsActivity;
...
import com.shosen.max.ui.activity.MyCommunityActivity;
import com.shosen.max.ui.activity.MyInvitationActivity;
import com.shosen.max.ui.activity.MyOrderActivity;
import com.shosen.max.ui.activity.MyWalletActivity;
...
import com.shosen.planegame.game.PlaneGameActivity;
...
public class MineFragment extends BaseFragment implements MineFragmentContract.View {
    ...
    @OnClick({R.id.rl_my_order, R.id.tv_quit_login, R.id.rl_my_invite, R.id.my_allowance,
            ...
            R.id.rl_my_max, R.id.fl_my_partner_alter, R.id.rl_my_property, R.id.tv_user_level
            , R.id.tv_my_signature
    })
    public void OnClick(View view) {
        switch (view.getId()) {
            case R.id.rl_my_order:
                ...
                Intent intent = new Intent(getActivity(), MallOrderListActivity.class);
            ...
            case R.id.iv_avatar:
                ...
                //startActivity(new Intent(getActivity(), PlaneGameActivity.class));
    ...
    public void refreshUI() {
        if (LoginUtils.isLogin) {
            ...
            tvUserLevel.setText("LV" + LoginUtils.getUser().getLevel() + LoginUtils.getUser().getTitle());
