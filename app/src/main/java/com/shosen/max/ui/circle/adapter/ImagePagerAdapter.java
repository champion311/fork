...
public class ImagePagerAdapter extends PagerAdapter {
    ...
    private List<? extends BaseBannerBean> mData;
    ...
    public ImagePagerAdapter(List<? extends BaseBannerBean> mData, Context mContext) {
        this.mData = mData;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        GlideUtils.loadImage(mContext, mData.get(position).getUrl(), requestOptions
