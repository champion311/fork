...
public class OrderDetailActivity extends BaseActivity
    ...
    protected void initViewAndEvents() {
        ...
        GlideUtils.loadImage(this, Contstants.PRODUCE_IMAGE,
                requestOptions, GlideUtils.defaultTransOptions, ivOrderImage);
    ...
    public void showOrderDetails(OrderResponse response) {
        ...
        //5已经删除 &#
        //tvName.setText("姓&#12288;&#12288;名" + response.getBookUserName());
        tvName.append(response.getBookUserName());
        tvCellphone.setText(getString(R.string.cell_phone) + "\t\t" + response.getBookUserPhone());
        //tvZone.setText("地&#12288;&#12288;区" + response.getProvince() + " " + response.getCity());
        tvZone.append(response.getProvince() + " " + response.getCity());
